...
##### 4.1.1 Doom I (Shareware) <a name="doom1"></a>
...
##### 4.1.2 The Ultimate Doom <a name="doomu"></a>
...
##### 4.1.4 Master Levels of Doom II <a name="masterlevels"></a>
...
##### 4.1.5 Final Doom <a name="finaldoom"></a>
...
##### 4.1.6 Officially released levels <a name="official"></a>
...
###### 4.1.6.1 "Sewers" and "Betray" levels <a name="sewers"></a>
...
###### 4.1.6.2 "No Rest for the Living" episode <a name="nerve"></a>
...
##### 4.1.7 Semi-official levels <a name="semiofficial"></a>
###### 4.1.7.1 "The Lost Episode" <a name="lostepis"></a>
...
###### 4.1.7.2 John Romero's levels <a name="romero"></a>
...
##### 4.1.8 Using WadSmoosh to create "Doom Complete" compilation <a name="wadsmoosh"></a>
...
#### 4.2 Steps to install the DoomBroLauncher <a name="stepsinstall"></a>
...
## 5. Details of preconfigured settings <a name="details"></a>

### 5.1 Game Settings <a name="gamesettings"></a>
...
### 5.2 Controller Settings <a name="controller"></a>
...
#### 5.3 Preconfigured controller bindings for XInput devices (Xbox 360 or Xbox One controllers) <a name="bindings"></a>
...
##### 5.3.1 Xbox 360 and Xbox One key bindings <a name="xbox"></a>
...
## 6. Advanced Configuration (optional) <a name="advance"></a>
In this section we are going to explain how you can customize DoomBroLauncher based on your needs.

### 6.1 Create more batch-scripts to run new Doom games or mods <a name="newscript"></a>
...
#### 6.1.1 Create an script for an IWAD (complete games) <a name="iwad"></a>
...
#### 6.1.2 Create an script for a PWAD (a mod for a game) <a name="pwad"></a>
...
### 6.2 Changing the Game Skill (difficulty) <a name="skill"></a>
...
### 6.3 Integration with EmulationStation <a name="emulationStation"></a>
