...
REM Map: MAP09
REM Title: Vesperas: 7th Canto of INFERNO
%PORT_EXECUTABLE% %PORT_PARAMETERS% -iwad wads/DOOM2.WAD -file wads/master_levels/VESPERAS.WAD +map MAP09 %SKILL_DEFAULT%
