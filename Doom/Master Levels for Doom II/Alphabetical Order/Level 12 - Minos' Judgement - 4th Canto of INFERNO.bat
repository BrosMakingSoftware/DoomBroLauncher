...
REM Map: MAP05
REM Title: Minos' Judgement: 4th Canto of INFERNO
%PORT_EXECUTABLE% %PORT_PARAMETERS% -iwad wads/DOOM2.WAD -file wads/master_levels/MINOS.WAD +map MAP05 %SKILL_DEFAULT%
